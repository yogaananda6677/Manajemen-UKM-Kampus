...
<div  class=" fixed top-0 left-0 w-full h-full bg-black/50 z-50 flex items-center justify-center" >
  <form action="aksi-update_jurusan.php" method="post" class="p-6 rounded-2xl border bg-white space-y-4 max-w-sm w-full shadow-xl">
    <h3 class="text-2xl font-bold text-center">Form Update Jurusan</h3>
    ...
    <div class="form-control">
      ...
      <input required id="nama" name="nama_jurusan" type="text" class="input rounded-xl input-bordered w-full" value="<?= htmlspecialchars($jur_data['NAMA_JURUSAN']); ?>" />
    </div>

    <button type="submit" class="btn btn-primary w-full rounded-xl">Simpan</button>
    <a href="jurusan.php" class="btn btn-neutral w-full rounded-xl text-center">Kembali</a>
  </form>
</div>
