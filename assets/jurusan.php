...
if (isset($_GET['status']) && $_GET['status'] === 'success') {
    $successMessage = "Data berhasil diperbarui!";
        ...
        $errorMessage = "Terjadi kesalahan saat memperbarui data (Nama Jurusan sudah digunakan).";
}
    ...
    <div class="drawer lg:drawer-open">
      ...
      <div class="drawer-content flex flex-col items-start justify-start">
        ...
        <div
          ...
          <div class="flex justify-end w-ful bg-amber my-5">
            
            
            <select id="filterSelect" class="btn btn-dash btn-accent hidden" name="filter">
            ...
            <button class="btn btn-primary" value="Submit" name="tambah_data" onclick="tambahJurusan()">Tambah Data</button>
            </div>
...
<div id="pagination" class="join mt-4 flex justify-center flex-wrap gap-1"></div>
      ...
      <div class="drawer-side">
        ...
        >
          ...
          <li>
            <a href="profil.php" class="rounded-box bg-slate-800 text-slate-200"
...
<?php include('tambah_jurusan.php'); ?>
...
function tambahJurusan() {
  const tambahJurusan = document.getElementById("tambahDataJurusan");
  tambahJurusan.classList.remove("hidden");
}
...
window.addEventListener("DOMContentLoaded", () => {
  ...
  const formTambah = document.getElementById("tambahData");
  const alertSuccess = document.getElementById("alertSuccess");
  const alertError = document.getElementById("alertError");
