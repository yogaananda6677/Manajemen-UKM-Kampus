  ...
  <body class="bg-base-200 font-heading">
    ...
    <div class="drawer lg:drawer-open">
      ...
      <div class="drawer-content flex flex-col items-start justify-start">
        ...
        <div class="overflow-x-auto rounded-box border border-base-content/5 mt-8 bg-slate-100">
...
<?php include('tambah_anggota.php'); ?>
...
// COPY
  ...
  const tambahParam = new URLSearchParams(window.location.search).get("tambah");
  if (tambahParam === "1") {
...
window.addEventListener("DOMContentLoaded", () => {
  ...
  if (alertSuccess || alertError) {
    ...
    setTimeout(() => {
      if (tambahAnggota) {
        tambahAnggota.classList.add("hidden");
      }
    }, 0);
  }
});
